...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "net1" do | p |
   p.vm.box = 'minimal/centos7'
   p.vm.host_name = "net1"
   p.vm.network  "public_network", bridge: "en0: Wi-Fi (AirPort)"
  ...
  config.vm.define "net2" do | b |
   b.vm.box= 'minimal/centos7'
   b.vm.host_name = "net2"

   b.vm.network  "public_network", bridge: "en0: Wi-Fi (AirPort)"
